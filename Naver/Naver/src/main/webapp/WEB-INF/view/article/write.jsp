...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#writeBtn2").click(function(){
			$("#writeForm").attr({"method":"post","action":"./doWrite"}).submit();
		});
					...
					<div style="margin-top: 5px; width: 100%; border: 1px solid #ccc;">
						<div style="margin: 20px;">
							...
							<div>
								...
								<input id="title" name="title" type="text" style="width: 60%" placholder="게시판 제목을 입력하세요" />
							</div>
							<div>
								<div class="block" style="width: 75px;">파일첨부</div>
								<div class="block">사진 | 동영상 | 지도 | GPS | 일정 | 링크 | 파일 | 투표
									| 음악</div>
							</div>
							<div>
								<div class="block" style="width: 75px;">정보첨부</div>
								<div class="block">책DB | 영화DB | 드라마DB | 음악DB | 상품DB | 인물DB
									| 날씨DB | 지식백과DB</div>
							</div>
						...
						id="writeBtn2" style="font-weight:bold;border-radius:3px;border:2px solid #ccc;background:white;margin-bottom:30px;width:80px;height:30px;" value="확인"/></div>
					</div>
					</form>
				</div>
				<div class="clear"></div>
