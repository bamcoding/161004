			...
			<div style="margin: 10px 20px 30px 0px;">
				...
				<div style="margin: 30px 0px 30px 0px;">
					...
					<div class="block vertical" style="margin: 0px 20px 0px 40px;">
						<div>
							<span style="font-size: 20px; font-weight: bold;">신의탑</span> 
							<span style="font-size: 14px;">${story.managerId}</span>
						</div>
						<br />
						<br />
						<div>
				...
				<div style="font-size: 20px;">
					...
					<div class="block right"><a href="./doDelete?id=${story.id }">삭제</a></div>
					</div>
					<div class="right_clear" style="padding:5px 20px 5px 20px;border-bottom:1px solid #efefef;">
					<div class="block">☆☆☆☆☆별점   ${story.likeCount}</div>
					<div class="block">조회수   ${story.hitCount}</div>
					<div class="block right">${story.createdDate }</div>
					</div>
					<div class="right_clear" style="padding:5px 20px 5px 20px;height:500px;">${story.content }</div>
				</div>
			</div>
		</div>
